...
import com.falaer.cn.config.AudioFocusManager;
import com.falaer.cn.config.MyApplication;
import com.falaer.cn.config.PreferenceHelper;
import com.falaer.cn.model.HostModel;
import com.falaer.cn.model.NotifyModel;
import com.falaer.cn.model.SerializableMap;
import com.falaer.cn.util.ConstantUtil;
import com.falaer.cn.util.DialogManager;
import com.falaer.cn.view.CustomBaseDialog;
            ...
            public void messageArrived(String topic, String message, int qos) {
                ...
                if (topic.contains("wit/cbox/app")) {
                    ...
                    if (message.contains("notify")) {
                        //判断当前不是启动页面或诊断页面
                        if (!((Activity)  MyApplication.getAppContext()).getLocalClassName().equals("com.falaer.cn.activity.SplashActivity") &&
                                !((Activity)  MyApplication.getAppContext()).getLocalClassName().equals("com.falaer.cn.activity.DiagnosisActivity")) {
                            //故障、报警
                            Gson gson = new Gson();
