...
import com.falaer.cn.model.GuZhangDetailsModel;
import com.falaer.cn.util.NavigationUtils;
    ...
    AMap.OnMarkerClickListener mMarkerListener = new AMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            try {
                ...
                com.falaer.cn.app.UIHelper.ToastMessage(MyApplication.getApp().getApplicationContext(), "请下载高德后重新尝试", Toast.LENGTH_SHORT);
            }
