...
public class GongxiangWzwAddActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_gongxiangwzw_add;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, GongxiangWzwAddActivity.class);
