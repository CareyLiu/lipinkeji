...
public class JinnuoJiebangActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jinnuo_act_jiebang;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinnuoJiebangActivity.class);
