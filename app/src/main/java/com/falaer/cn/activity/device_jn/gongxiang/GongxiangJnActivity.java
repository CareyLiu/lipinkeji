package com.falaer.cn.activity.device_jn.gongxiang;
...
public class GongxiangJnActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_gongxiangjn_list;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, GongxiangJnActivity.class);
    ...
    private void initAdapter() {
        adapter = new GongxiangAdapter(R.layout.item_shebei_gongxiang_jinnuo, data);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (data != null && data.size() > position) {
                    ...
                    GongxiangJnDelectActivity.actionStart(mContext, ccidMa, dataBean.getUser_name(), dataBean.getUser_phone(), dataBean.getOf_user_id());
                }
            }
        });
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_back:
                ...
                break;
            case R.id.tv_add:
                GongxiangJnAddActivity.actionStart(mContext, ccidMa);
                break;
        }
    }
}
