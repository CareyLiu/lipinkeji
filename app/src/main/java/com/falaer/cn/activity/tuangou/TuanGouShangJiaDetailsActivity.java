...
import com.falaer.cn.adapter.ShangJiaNearbyAdapter;
import com.falaer.cn.adapter.tuangou.TuanGouShangJiaDetailsAdapter;
import com.falaer.cn.adapter.tuangou.TuanGouShangJiaHighScoreList1Adapter;
import com.falaer.cn.callback.JsonCallback;
import com.falaer.cn.common.StringUtils;
import com.falaer.cn.config.AppResponse;
import com.falaer.cn.config.GlideImageLoader;
import com.falaer.cn.get_net.Urls;
import com.falaer.cn.model.TuanGouShangJiaDetailsModel;
...
import static com.falaer.cn.get_net.Urls.LIBAOLIST;
...
public class TuanGouShangJiaDetailsActivity extends AbStracTuanGouShangJiaDetails {
    ...
    public void setFotter() {
        ...
        shangJiaNearbyAdapter.setOnItemChildClickListener(new com.falaer.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter.OnItemChildClickListener() {
            @Override
            public void onItemChildClick(com.falaer.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    /**
                     *        tvShopName.setText(storeListBean.getInst_name());
