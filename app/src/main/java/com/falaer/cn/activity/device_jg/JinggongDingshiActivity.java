...
public class JinggongDingshiActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jinggong_act_dingshi;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinggongDingshiActivity.class);
