...
public class GongxiangWzwDelectActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_gongxiangwzw_delete;
    }
    ...
    public static void actionStart(Context context, String ccid, String name, String phone, String of_user_id_beShared) {
        Intent intent = new Intent(context, GongxiangWzwDelectActivity.class);
