...
public class TongyongMainActivity extends BaseActivity implements View.OnLongClickListener {
    ...
    public int getContentViewResId() {
        return R.layout.a_tongyong_act_main;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, TongyongMainActivity.class);
    ...
    private void getData(String msg) {//接收到信息
        ...
        tv_yushe_wendu.setText("预设温度：" + Y.getInt(wendu_rufengkou) + "℃");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_back:
                ...
                break;
            case R.id.rl_set:
                TongyongSetActivity.actionStart(mContext);
                break;
            case R.id.ll_shuoming:
                TongyongShuomingActivity.actionStart(mContext);
                break;
        }
    }
    ...
    private void setUiHengwen(String yushewendu) {
        ...
        isKaiji = true;
        tv_mode_hengwen.setTextColor(Y.getColor(R.color.ty_text));
        tv_mode_hengwen_kai.setTextColor(Y.getColor(R.color.ty_text));
        bt_mode_hengwen.setBackgroundResource(R.mipmap.tongyong_wendu_bg);
    ...
    private void setUiShoudong(String dangwei) {
        ...
        Glide.with(mContext).asGif().load(R.drawable.fengnuan_kaiji).into(iv_jiareqi);
        isKaiji = true;
        tv_mode_shoudong.setTextColor(Y.getColor(R.color.ty_text));
        tv_mode_shoudong_kai.setTextColor(Y.getColor(R.color.ty_text));
        bt_mode_shoudong.setBackgroundResource(R.mipmap.tongyong_wendu_bg);
    ...
    private void setUiGuanji() {
        ...
        bt_mode_shoudong.setBackgroundResource(R.mipmap.tongyong_wendu_bg_2);

        tv_mode_hengwen.setTextColor(Y.getColor(R.color.white));
        tv_mode_hengwen_kai.setTextColor(Y.getColor(R.color.white));
        bt_mode_hengwen.setBackgroundResource(R.mipmap.tongyong_wendu_bg_2);

        tv_mode_bengyou.setTextColor(Y.getColor(R.color.white));
        bt_mode_bengyou.setBackgroundResource(R.mipmap.tongyong_wendu_bg_2);
    ...
    private void setUiBengyou() {
        ...
        bt_mode_bengyou.setBackgroundResource(R.mipmap.tongyong_wendu_bg);
        bengyouDialog.setTextConfirm("停止泵油");
        if (bengyouDialog != null && !bengyouDialog.isShowing()) {
            bengyouDialog.show();
        }
