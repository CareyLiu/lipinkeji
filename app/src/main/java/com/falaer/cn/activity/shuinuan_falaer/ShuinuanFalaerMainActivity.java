package com.falaer.cn.activity.shuinuan_falaer;
...
import com.falaer.cn.activity.FengnuandishiActivity;
import com.falaer.cn.activity.SheBeiSetActivity;
import com.falaer.cn.activity.shuinuan.ShuinuanBaseNewActivity;
import com.falaer.cn.activity.shuinuan.Y;
import com.falaer.cn.activity.shuinuan.dialog.GuzhangDialog;
import com.falaer.cn.activity.shuinuan_wzw.ShuinuanWzwShuomingActivity;
...
public class ShuinuanFalaerMainActivity extends ShuinuanBaseNewActivity implements View.OnLongClickListener {
    ...
    @BindView(R.id.bt_waijiezhuangzhi)
    TextView bt_waijiezhuangzhi;
    ...
    public int getContentViewResId() {
        return R.layout.activity_shuinuanfalaer_main;
    }
    ...
    private void initView() {
        ...
        bt_waijiezhuangzhi.setOnLongClickListener(this);
    ...
    private void waijizhuangzhi() {
        if (isWaijizhuangzhi) {
            SoundPoolUtils.soundPool(mContext, R.raw.relay_close);
            typeMingling = 8;
            sendMingling();
//            initHandlerMingling();
            setWaijieUiGuan();
        } else {
            SoundPoolUtils.soundPool(mContext, R.raw.relay_open);
            typeMingling = 7;
            sendMingling();
//            initHandlerMingling();
            setWaijieUiKai();
...
//        initHandlerMingling();
    ...
    private void setWaijieUiKai() {
        isWaijizhuangzhi = true;
        bt_waijiezhuangzhi.setBackgroundResource(R.mipmap.falaer_shuinuan_wjzz_sel);
        bt_waijiezhuangzhi.setTextColor(Y.getColor(R.color.falaer_text_shuinuan));
    }

    private void setWaijieUiGuan() {
        isWaijizhuangzhi = false;
        bt_waijiezhuangzhi.setBackgroundResource(R.mipmap.falaer_shuinuan_wjzz_nor);
        bt_waijiezhuangzhi.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
    }


    private void setYoubengUiGuan() {
        isYoubeng = false;
        bt_youbeng.setBackgroundResource(R.mipmap.falaer_shuinuan_right_nor);
        bt_youbeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
    }

    private void setYoubengUiKai() {
        isYoubeng = true;
        bt_youbeng.setBackgroundResource(R.mipmap.falaer_shuinuan_right_sel);
        bt_youbeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan));
    }

    private void setShuibengUiGuan() {
        isShuibeng = false;
        bt_shuibeng.setBackgroundResource(R.mipmap.falaer_shuinuan_left_nor);
        bt_shuibeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
    }

    private void setShuibengUiKai() {
        isShuibeng = true;
        bt_shuibeng.setBackgroundResource(R.mipmap.falaer_shuinuan_left_sel);
        bt_shuibeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan));
    }
    ...
    private void setUiGuanji() {
        ...
        bt_kaiji.setBackgroundResource(R.mipmap.falaer_shuinuan_left_nor);
        bt_kaiji.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
        bt_guanji.setBackgroundResource(R.mipmap.falaer_shuinuan_right_sel);
        bt_guanji.setTextColor(Y.getColor(R.color.falaer_text_shuinuan));
        bt_shuibeng.setBackgroundResource(R.mipmap.falaer_shuinuan_left_nor);
        bt_shuibeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
        bt_youbeng.setBackgroundResource(R.mipmap.falaer_shuinuan_right_nor);
        bt_youbeng.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
    ...
    private void setUiKaiji() {
        ...
        bt_kaiji.setBackgroundResource(R.mipmap.falaer_shuinuan_left_sel);
        bt_kaiji.setTextColor(Y.getColor(R.color.falaer_text_shuinuan));
        bt_guanji.setBackgroundResource(R.mipmap.falaer_shuinuan_right_nor);
        bt_guanji.setTextColor(Y.getColor(R.color.falaer_text_shuinuan_lan));
