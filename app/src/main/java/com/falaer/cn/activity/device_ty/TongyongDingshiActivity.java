...
import com.falaer.cn.model.DingShiResultModel;
...
public class TongyongDingshiActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_tongyong_act_dingshi;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, TongyongDingshiActivity.class);
