package com.falaer.cn.activity.taokeshagncheng;
...
import com.falaer.cn.activity.AddressActivity;
import com.falaer.cn.adapter.zijian_adapter.QueRenDingDanAdapter;
...
import com.falaer.cn.model.AddressListModel;
import com.falaer.cn.model.AddressModel;
...
import com.falaer.cn.project_A.zijian_interface.QueRenDingDanInterface;
import com.falaer.cn.util.AlertUtil;
import com.falaer.cn.util.NeedYanZheng;
...
//            deduction_type	是否用红包抵扣：1.不用 2.用		否
    ...
    private void showSingSelect() {
        ...
        choice = 0;
        builder = new AlertDialog.Builder(this).setIcon(R.mipmap.logi_icon).setTitle("选择您的购买方式")
