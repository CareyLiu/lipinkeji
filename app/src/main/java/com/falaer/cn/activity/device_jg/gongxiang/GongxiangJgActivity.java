package com.falaer.cn.activity.device_jg.gongxiang;
...
import com.falaer.cn.activity.shuinuan.gongxiang.GongxiangAdapter;
import com.falaer.cn.activity.shuinuan.gongxiang.GongxiangModel;
import com.falaer.cn.activity.shuinuan_wzw.gongxiang.GongxiangWzwAddActivity;
import com.falaer.cn.activity.shuinuan_wzw.gongxiang.GongxiangWzwDelectActivity;
...
public class GongxiangJgActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_gongxiangjg_list;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, GongxiangJgActivity.class);
    ...
    private void initAdapter() {
        adapter = new GongxiangAdapter(R.layout.item_shebei_gongxiang_jinggong, data);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (data != null && data.size() > position) {
                    ...
                    GongxiangJgDelectActivity.actionStart(mContext, ccidMa, dataBean.getUser_name(), dataBean.getUser_phone(), dataBean.getOf_user_id());
                }
            }
        });
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_back:
                ...
                break;
            case R.id.tv_add:
                GongxiangJgAddActivity.actionStart(mContext, ccidMa);
                break;
        }
    }
}
