...
public class JinnuoWeixiuActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jinnuo_act_weixiujilu;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinnuoWeixiuActivity.class);
