...
public class ShuinuanWzwMainActivityNew extends ShuinuanBaseNewActivity implements View.OnLongClickListener {
    ...
    @BindView(R.id.iv_youbeng)
    ImageView iv_youbeng;
    @BindView(R.id.iv_shuibeng)
    ImageView iv_shuibeng;
    ...
    private int typeMingling;//0 获取实时数据、1 开机、2 关机、3 油泵开、4 油泵关、5 水泵开、6水泵关

    @Override
    public int getContentViewResId() {
        return R.layout.activity_shuinuanwzw_main_new;
    }
    ...
    public static void actionStart(Context context, String ccid, String car_server_id, String time) {
        Intent intent = new Intent(context, ShuinuanWzwMainActivityNew.class);
    ...
    @OnClick({R.id.rl_back, R.id.rl_set, R.id.ll_shuoming, R.id.tv_shebeima, R.id.ll_dingshi, R.id.bt_pingbi})
    ...
    private void setYoubengUiGuan() {
        isYoubeng = false;
        iv_youbeng.setVisibility(View.INVISIBLE);
    }

    private void setYoubengUiKai() {
        isYoubeng = true;
        iv_youbeng.setVisibility(View.VISIBLE);
    }

    private void setShuibengUiGuan() {
        isShuibeng = false;
        iv_shuibeng.setVisibility(View.INVISIBLE);
    }

    private void setShuibengUiKai() {
        isShuibeng = true;
        iv_shuibeng.setVisibility(View.VISIBLE);
    }
    ...
    private void setUiGuanji() {
        ...
        iv_kaiji.setVisibility(View.INVISIBLE);
        iv_guanji.setVisibility(View.VISIBLE);
        iv_shuibeng.setVisibility(View.INVISIBLE);
        iv_youbeng.setVisibility(View.INVISIBLE);
    }
    ...
    private void setUiKaiji() {
        ...
        iv_kaiji.setVisibility(View.VISIBLE);
        iv_guanji.setVisibility(View.INVISIBLE);
