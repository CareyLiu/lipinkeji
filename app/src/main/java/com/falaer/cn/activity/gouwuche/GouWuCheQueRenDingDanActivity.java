package com.falaer.cn.activity.gouwuche;
...
import com.falaer.cn.adapter.GouWuCheQueRenDingDanAdapter;
...
import com.falaer.cn.model.GouWuCheZhengHeModel;
...
public class GouWuCheQueRenDingDanActivity extends BaseActivity implements QueRenDingDanInterface {
    ...
    private String userHongBao = "1";//1 否 2是
    EditText etLiuYan;
