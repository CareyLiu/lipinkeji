...
public class GongxiangJnAddActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_gongxiangjn_add;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, GongxiangJnAddActivity.class);
