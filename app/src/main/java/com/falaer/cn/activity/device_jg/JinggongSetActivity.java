...
public class JinggongSetActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jinggong_act_set;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinggongSetActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_dingshi:
                JinggongDingshiActivity.actionStart(mContext);
                break;
            case R.id.ll_jiareqizhuangtai:
                JinggongStateActivity.actionStart(mContext);
                break;
            case R.id.ll_weixiujilu:
                JinggongWeixiuActivity.actionStart(mContext);
                break;
            case R.id.ll_jiebang:
                JinggongJiebangActivity.actionStart(mContext);
                break;
            case R.id.ll_guzhang:
                DiagnosisActivity.actionStart(mContext);
                break;
            case R.id.rl_gongxiang:
                GongxiangJgActivity.actionStart(mContext, ccid);
                break;
