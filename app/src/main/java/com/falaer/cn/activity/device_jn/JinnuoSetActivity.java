...
import com.falaer.cn.activity.device_jg.gongxiang.GongxiangJgActivity;
import com.falaer.cn.activity.device_jn.gongxiang.GongxiangJnActivity;
...
public class JinnuoSetActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jinnuo_act_set;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinnuoSetActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_dingshi:
                JinnuoDingshiActivity.actionStart(mContext);
                break;
            case R.id.ll_jiareqizhuangtai:
                JinnuoStateActivity.actionStart(mContext);
                break;
            case R.id.ll_weixiujilu:
                JinnuoWeixiuActivity.actionStart(mContext);
                break;
            case R.id.ll_jiebang:
                JinnuoJiebangActivity.actionStart(mContext);
                break;
            case R.id.ll_guzhang:
                DiagnosisActivity.actionStart(mContext);
                break;
            case R.id.rl_gongxiang:
                GongxiangJnActivity.actionStart(mContext, ccid);
                break;
