...
public class JinggongStateActivity extends BaseActivity {
    ...
    private boolean isZaixian;//是否在线

    @Override
    public int getContentViewResId() {
        return R.layout.a_jinggong_act_zhuangtai;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, JinggongStateActivity.class);
