...
public class TongyongStateActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_tongyong_act_zhuangtai;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, TongyongStateActivity.class);
