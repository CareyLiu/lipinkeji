...
public class HomeZiYingAdapter extends BaseQuickAdapter<Home.DataBean.ProShowListBean, BaseViewHolder> {
    public HomeZiYingAdapter(int layoutResId, @Nullable List<Home.DataBean.ProShowListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Home.DataBean.ProShowListBean item) {
