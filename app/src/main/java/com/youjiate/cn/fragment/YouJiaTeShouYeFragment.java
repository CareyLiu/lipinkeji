 ...
 */
public class YouJiaTeShouYeFragment extends BaseFragment implements ObservableScrollView.ScrollViewListener, View.OnClickListener {
    ...
    protected int getLayoutRes() {
        return R.layout.layout_homefragment_youjiate;
    }
