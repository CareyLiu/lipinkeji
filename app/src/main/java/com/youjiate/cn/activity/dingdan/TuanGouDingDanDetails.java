package com.youjiate.cn.activity.dingdan;
...
import com.youjiate.cn.model.DingDanDetailsModel;
...
import com.youjiate.cn.util.Tools;
import com.youjiate.cn.util.phoneview.sample.ImageShow_OnePictureActivity;
...
import static com.youjiate.cn.get_net.Urls.HOME_PICTURE_HOME;
                    ...
                    public void onSuccess(Response<AppResponse<DingDanDetailsModel.DataBean>> response) {
                        ...
                        switch (dataBean.getUser_pay_check()) {
                            ...
                            case "5":
                                ...
                                Bitmap b = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.logi_icon);
