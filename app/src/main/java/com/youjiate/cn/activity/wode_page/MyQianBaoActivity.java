package com.youjiate.cn.activity.wode_page;
...
import com.youjiate.cn.adapter.MyQianBaoAdapter;
...
import com.youjiate.cn.model.MyQianBaoModel;
import com.youjiate.cn.model.MyQianBaoXianFeiMingXiModel;
...
public class MyQianBaoActivity extends BaseActivity {
    ...
    private void showWeiXinOrZhiFuBaoSelect() {
        ...
        builder = new AlertDialog.Builder(this).setIcon(R.mipmap.logi_icon).setTitle("选择您的提现方式")
