...
import com.youjiate.cn.model.DingShiResultModel;
...
public class FalaerDingshiActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_falaer_act_dingshi;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, FalaerDingshiActivity.class);
