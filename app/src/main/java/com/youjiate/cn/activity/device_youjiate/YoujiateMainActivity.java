...
//            tv_youbengpinlv.setText("油泵频率：" + youbengpinlv + "Hz");
    ...
    private void setUiShoudong() {
        isKaiji = true;
        isHenwenMode = false;
        bt_kaiguan.setImageResource(R.mipmap.yjt_stop_sel);
        setDangwei(dangwei);
        ...
        iv_add.setImageResource(R.mipmap.yjt_fn_jidang_sel);
        iv_reduce.setImageResource(R.mipmap.yjt_fn_jiandang_sel);
    ...
    private void setUiGuanji() {
        isKaiji = false;
        bt_kaiguan.setImageResource(R.mipmap.yjt_stop_nor);
        ...
        iv_add.setImageResource(R.mipmap.yjt_fn_jidang);
        iv_reduce.setImageResource(R.mipmap.yjt_fn_jiandang);
