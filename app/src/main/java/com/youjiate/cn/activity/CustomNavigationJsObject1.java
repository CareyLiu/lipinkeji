...
import com.youjiate.cn.activity.fenxiang_tuisong.ShouYeFenXiangActivity;
import com.youjiate.cn.activity.wode_page.TiXianActivity;
...
import com.youjiate.cn.config.Wetch_S;
import com.youjiate.cn.get_net.Urls;
import com.youjiate.cn.model.DaiLiShangQianBaoModel;
import com.youjiate.cn.model.GaoDeMapModel;
import com.youjiate.cn.model.Home;
import com.youjiate.cn.model.MenSuoModel;
import com.youjiate.cn.model.SaoMaPayModel;
import com.youjiate.cn.model.SaoMaWeiXinPayModel;
import com.youjiate.cn.model.SaoMaZhiFuBaoPayModel;
import com.youjiate.cn.pay_about.alipay.PayResult;
import com.youjiate.cn.util.AppUtils;
import com.youjiate.cn.util.OpenLocalMapUtil;
...
//        builder.show();
        ...
        if (baiDuFlag) {
            ...
            if (OpenLocalMapUtil.isBaiduMapInstalled()) {
                try {
                    String uri = OpenLocalMapUtil.getBaiduMapUri(String.valueOf(qiDianLa), String.valueOf(qiDianLo), "当前位置",
                            String.valueOf(latitude), String.valueOf(longitude), gaoDeMapModel.getGps_address(), "", "法拉尔科技");
            ...
            String uri = OpenLocalMapUtil.getGdMapUri("法拉尔科技", String.valueOf(qiDianLa), String.valueOf(qiDianLo),
...
//                        }
    ...
    private void showWeiXinOrZhiFuBaoSelect(Response<AppResponse<DaiLiShangQianBaoModel.DataBean>> response) {
        ...
        builder = new AlertDialog.Builder(mContext).setIcon(R.mipmap.logi_icon).setTitle("选择您的提现方式")
