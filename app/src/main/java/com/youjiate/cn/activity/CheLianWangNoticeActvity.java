...
import com.youjiate.cn.model.GuZhangDetailsModel;
    ...
    AMap.OnMarkerClickListener mMarkerListener = new AMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            try {
                ...
                com.youjiate.cn.app.UIHelper.ToastMessage(MyApplication.getApp().getApplicationContext(), "请下载高德后重新尝试", Toast.LENGTH_SHORT);
            }
