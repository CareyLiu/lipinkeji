...
public class LipinXiaoshuiActivity extends ShuinuanBaseNewActivity implements View.OnLongClickListener {
    ...
    public int getContentViewResId() {
        return R.layout.a_shuinuan_act_main_lipin_xiao;
    }
    ...
    public static void actionStart(Context context, String ccid, String car_server_id) {
        Intent intent = new Intent(context, LipinXiaoshuiActivity.class);
...
//            SoundPoolUtils.soundPool(mContext, R.raw.shuinuan_youbeng_on);
    ...
    private void setJitanUiGuan() {
        isJitan = false;
        bt_jitan.setBackgroundResource(R.mipmap.sn_btn_guanbi);
    }

    private void setJitanUiKai() {
        isJitan = true;
        bt_jitan.setBackgroundResource(R.mipmap.sn_btn_kaiqi);
    }


    private void setYoubengUiGuan() {
        isYoubeng = false;
        bt_youbeng.setBackgroundResource(R.mipmap.sn_btn_guanbi);
    }

    private void setYoubengUiKai() {
        isYoubeng = true;
        bt_youbeng.setBackgroundResource(R.mipmap.sn_btn_kaiqi);
    }

    private void setShuibengUiGuan() {
        isShuibeng = false;
        bt_shuibeng.setBackgroundResource(R.mipmap.sn_btn_guanbi);
    }

    private void setShuibengUiKai() {
        isShuibeng = true;
        bt_shuibeng.setBackgroundResource(R.mipmap.sn_btn_kaiqi);
    }

    private void setUiGuanji() {
        isKaiji = false;
        iv_heater_host.setBackgroundResource(R.mipmap.wzw_xiaoshui_shebei_nor);

        bt_kaiji.setText("开机");
        bt_kaiji.setBackgroundResource(R.mipmap.sn_btn_guanbi);
        bt_shuibeng.setBackgroundResource(R.mipmap.sn_btn_guanbi);
        bt_youbeng.setBackgroundResource(R.mipmap.sn_btn_guanbi);
        bt_jitan.setBackgroundResource(R.mipmap.sn_btn_guanbi);
    }
    ...
    private void setUiKaiji() {
        ...
        iv_heater_host.setBackgroundResource(R.drawable.shuinuan_kaiji_xiao);
        AnimationDrawable animationDrawable = (AnimationDrawable) iv_heater_host.getBackground();
        animationDrawable.start();

        bt_kaiji.setText("关机");
        bt_kaiji.setBackgroundResource(R.mipmap.sn_btn_kaiqi);
