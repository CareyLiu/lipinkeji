...
public class ShuinuanGongxiangActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_shuinuan_act_gongxiang_list;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, ShuinuanGongxiangActivity.class);
    ...
    private void initAdapter() {
        adapter = new GongxiangAdapter(R.layout.a_shuinuan_item_gongxiang_shebei, data);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (data != null && data.size() > position) {
                    ...
                    ShuinuanGongxiangDelectActivity.actionStart(mContext, ccidMa, dataBean.getUser_name(), dataBean.getUser_phone(), dataBean.getOf_user_id());
                }
            }
        });
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_back:
                ...
                break;
            case R.id.tv_add:
                ShuinuanGongxiangAddActivity.actionStart(mContext, ccidMa);
                break;
        }
    }
}
