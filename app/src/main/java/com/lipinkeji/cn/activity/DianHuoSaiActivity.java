...
public class DianHuoSaiActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.layout_dianhuosai;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, DianHuoSaiActivity.class);
