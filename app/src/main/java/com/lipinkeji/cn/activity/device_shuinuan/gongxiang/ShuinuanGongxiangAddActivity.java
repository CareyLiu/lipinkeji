...
public class ShuinuanGongxiangAddActivity extends ShuinuanBaseNewActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_shuinuan_act_gongxiang_add;
    }
    ...
    public static void actionStart(Context context, String ccid) {
        Intent intent = new Intent(context, ShuinuanGongxiangAddActivity.class);
