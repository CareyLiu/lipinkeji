...
import com.lipinkeji.cn.adapter.ShangJiaNearbyAdapter;
import com.lipinkeji.cn.adapter.tuangou.TuanGouShangJiaDetailsAdapter;
import com.lipinkeji.cn.adapter.tuangou.TuanGouShangJiaHighScoreList1Adapter;
...
public class TuanGouShangJiaDetailsActivity extends AbStracTuanGouShangJiaDetails {
    ...
    public void setFotter() {
        ...
        shangJiaNearbyAdapter.setOnItemChildClickListener(new com.lipinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter.OnItemChildClickListener() {
            @Override
            public void onItemChildClick(com.lipinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    /**
                     *        tvShopName.setText(storeListBean.getInst_name());
