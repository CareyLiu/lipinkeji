package com.lipinkeji.cn.activity.device_a.gongxiang;
...
public class GongxiangActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_jiareqi_act_gongxiang_list;
    }
    ...
    private void initAdapter() {
        adapter = new GongxiangAdapter(R.layout.a_jiareqi_item_gongxiang_shebei, data);
