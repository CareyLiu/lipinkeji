...
public class FalaerJiebangActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.a_falaer_act_jiebang;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, FalaerJiebangActivity.class);
