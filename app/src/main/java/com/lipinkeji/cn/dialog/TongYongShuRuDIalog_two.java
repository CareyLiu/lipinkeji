...
import com.lipinkeji.cn.util.Util;


public class TongYongShuRuDIalog_two implements View.OnClickListener {
    ...
    private ShuRuInterTwoView shuRuInterView;
    private String shuRu;


    public TongYongShuRuDIalog_two(@NonNull Context context, ShuRuInterTwoView shuRuInterView, String strShuRu) {
        mContext = context;
    ...
    private void initView() {
        ...
        mView = LayoutInflater.from(mContext).inflate(R.layout.dialog_shuru_two, null);
...
//        window.setWindowAnimations(R.style.dialogWindowAnim); // 添加动画
        ...
        et_name1 = mView.findViewById(R.id.et_name_xiaxian);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_submit:
                ...
                shuRuInterView.submit1(et_name1.getText().toString());
                shuRuInterView.baocun();
                Util.pickKey(mContext, mView);
                dismiss();
                break;
        }
