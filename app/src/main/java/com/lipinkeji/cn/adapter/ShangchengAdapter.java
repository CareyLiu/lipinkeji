...
public class ShangchengAdapter extends BaseQuickAdapter<ShangchengModel.DataBean.IndexShowListBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(com.lipinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseViewHolder helper, ShangchengModel.DataBean.IndexShowListBean item) {
